/* clarity-js v0.8.64: https://github.com/microsoft/clarity (License: MIT) */
!(function () {
  "use strict";
  var t,
    e,
  ...
  function Cn(e) {
    ...
    return (
      ...
      (i =
        e && e.view ? e.view.performance.timeOrigin : performance.timeOrigin),
      Math.max(Math.round(a + i - n), 0)
    );
  }
  function An(t, e) {
    var n, a, i, r;
    for (void 0 === e && (e = null), i = a = 5381, r = 0; r < t.length; r += 2)
      (a = ((a << 5) + a) ^ t.charCodeAt(r)),
        r + 1 < t.length && (i = ((i << 5) + i) ^ t.charCodeAt(r + 1));
    return (
      (n = Math.abs(a + 11579 * i)), (e ? n % Math.pow(2, e) : n).toString(36)
    );
  }
      ...
      switch (n) {
        ...
        case 3:
          switch (e) {
            ...
            case "xlink:href":
              return 3 === n
                ? (null == t ? void 0 : t.startsWith("blob:"))
                  ? "blob:"
                  : ""
                : t;
            case "value":
  ...
  function Hn() {
    s && (c = { time: Cn(), event: 4, data: Object.assign({}, l) }),
      (l = l || {
        visible: 1,
        docWidth: 0,
        docHeight: 0,
    ...
    if (
      ...
      try {
        if (null === _) {
          for (
            u =
              (o = location.hostname ? location.hostname.split(".") : [])
                .length - 1;
            u >= 0;
            u--
          )
            if (
              ((_ = "." + o[u] + (_ || "")),
              u < o.length - 1 &&
                ((document.cookie = r + ";domain=" + _), va(t) === e))
            )
              return;
          _ = "";
        }
  ...
  function ba(t, e, n) {
    xn.fraud &&
      ...
      n &&
      n.length >= 5 &&
      ((C = { id: t, target: e, checksum: An(n, 28) }),
  ...
  function wa(t) {
    ...
    a &&
      ((n =
        (e = a.value) && e.length >= 5 && xn.fraud && !R.includes(a.type)
          ? An(e, 28)
          : ""),
      j.push({
        time: Cn(t),
        event: 42,
        data: { target: dr(t), type: a.type, value: e, checksum: n },
      }),
      xr(hr.bind(this, 42)));
  }
  function ka() {
  ...
  function Ea(t, e, n) {
    var a,
      ...
      p =
        h && h.contentDocument
          ? h.contentDocument.documentElement
          : document.documentElement,
      g =
        "pageX" in n
          ? Math.round(n.pageX)
          : "clientX" in n
          ? Math.round(n.clientX + p.scrollLeft)
          : null,
      v =
        "pageY" in n
          ? Math.round(n.pageY)
          : "clientY" in n
          ? Math.round(n.clientY + p.scrollTop)
          : null;
    h &&
      ((a = Sa(h)),
      ...
      0 === n.detail &&
        o &&
        ((g = Math.round(o.x + o.w / 2)), (v = Math.round(o.y + o.h / 2))),
      (u = (function (t, e, n, a) {
        if (!a) return { eX: 0, eY: 0 };
        for (
          var i = a,
            r = t,
            o = Math.max(Math.floor(((e - i.x) / i.w) * 32767), 0),
            u = Math.max(Math.floor(((n - i.y) / i.h) * 32767), 0),
            c = 0;
          (o > 32767 || u > 32767) && r.parentElement && c < 10;

        )
          c++,
            (i = Na((r = r.parentElement))) &&
              ((o = Math.max(Math.floor(((e - i.x) / i.w) * 32767), 0)),
              (u = Math.max(Math.floor(((n - i.y) / i.h) * 32767), 0)));
        return { eX: o, eY: u };
      })(i, g, v, o)),
      ...
      null !== g &&
        ...
        ((s = (function (t) {
          ...
          return (
            t &&
              (e = t.textContent || String(t.value || "") || t.alt) &&
              (i =
                (a = (n = e.replace(/\s+/g, " ").trim()).substring(0, 25))
                  .length === n.length),
            { text: a, isFullText: i ? 1 : 0 }
          );
        })(i)),
        H.push({
          time: Cn(n),
  ...
  function Ta(t, e) {
    ...
    return t.nodeType === Node.ELEMENT_NODE &&
      "string" == typeof (n = null == t ? void 0 : t[e])
      ? null == n
        ? void 0
        : n.toLowerCase()
      : "";
  ...
  function Na(t) {
    ...
    return (
      "function" == typeof t.getBoundingClientRect &&
        ...
        e.width > 0 &&
        e.height > 0 &&
        ((n = "pageXOffset" in l ? l.pageXOffset : c.scrollLeft),
        ...
        (i = Ji(u)) &&
          ((r = Sa(i)), (o.x += Math.round(r.x)), (o.y += Math.round(r.y)))),
      o
    );
  }
  function Ma(t) {
  ...
  function _a() {
    ...
    try {
      for (
        ...
        (r = i[a]).includes("://")
          ? (n = !r.includes("extension") && r.includes(e) ? 1 : 2)
          : (r.includes("eval") ||
              r.includes("Function") ||
              r.includes("<a") ||
              W.test(r)) &&
  ...
  function xa(t, e) {
    q.push({ time: Cn(e), event: 38, data: { target: dr(e), action: t } }),
      xr(hr.bind(this, 38));
  }
  function Ia() {
    q = [];
  ...
  function Da(t) {
    ...
    if (i && i.type && r) {
      ...
      (a = { target: i, value: e, type: n, trust: t.isTrusted ? 1 : 0 }),
        z.length > 0 && z[z.length - 1].data.target === a.target && z.pop(),
        z.push({ time: Cn(t), event: 27, data: a }),
        Zn(U),
        (U = Gn(Aa, 750, 27));
    }
  }
  ...
  function Ra(t, e, n) {
    ...
    i &&
      ...
      null !== o &&
        null !== u &&
        Ya({ time: Cn(n), event: t, data: { target: dr(n), x: o, y: u } });
  }
  function La(t, e, n) {
    var a,
      i,
    ...
    if (d)
      for (a = 0; a < d.length; a++) {
        switch (
          ((r =
            "clientX" in (i = d[a])
              ? Math.round(i.clientX + s.scrollLeft)
              : null),
        ...
        (c = B && J === u),
          null !== r &&
            ...
            Ya({
              time: f,
              event: t,
              data: { target: dr(n), x: r, y: o, id: u, isPrimary: c },
            }),
          (20 !== t && 18 !== t) || (J === u && (B = !1));
      }
  }
  ...
  function za(t) {
    ...
    if (
      ...
      if (
        ...
        (u = window.innerWidth),
        (d = (c = window.innerHeight) - (s = u > c ? 0.15 * c : 0.2 * c)),
        (f = Fa((l = u / 3), s)),
        (h = Fa(l, d)),
        (p = t && t.isTrusted ? 1 : 0),
        (g = {
          time: Cn(t),
          event: 10,
          data: { target: a, x: r, y: o, top: f, bottom: h, trust: p },
        }),
        (null === t && 0 === r && 0 === o) || null === r || null === o)
      )
        return (et = f), void (nt = h);
      (m = (v = tt.length) > 1 ? tt[v - 2] : null) &&
        (function (t, e) {
          var n = t.data.x - e.data.x,
            a = t.data.y - e.data.y;
  ...
  function Ba() {
    ...
    et &&
      qr(
        31,
        null === (t = null == (n = fr(et, null)) ? void 0 : n.hash) ||
          void 0 === t
          ? void 0
          : t.join(".")
      ),
      nt &&
        qr(
          32,
          null === (e = null == (a = fr(nt, null)) ? void 0 : a.hash) ||
            void 0 === e
            ? void 0
            : e.join(".")
        );
  ...
  function Ja(t) {
    var e,
      n = (t.nodeType === Node.DOCUMENT_NODE ? t : document).getSelection();
    null !== n &&
      ((null === n.anchorNode && null === n.focusNode) ||
        (n.anchorNode === n.focusNode && n.anchorOffset === n.focusOffset) ||
        ((e = rt.start ? rt.start : null),
        null !== ot &&
          null !== rt.start &&
          e !== n.anchorNode &&
          (Zn(ut), Ka(21)),
  ...
  function Ga() {
    (ot = null), (rt = { start: 0, startOffset: 0, end: 0, endOffset: 0 });
  }
  function Za(t) {
    ct.push({ time: Cn(t), event: 39, data: { target: dr(t) } }),
      xr(hr.bind(this, 39));
  }
  function Qa() {
    ct = [];
  ...
  function $a(t) {
    (lt = { name: t.type, persisted: t.persisted ? 1 : 0 }),
      hr(26, Cn(t)),
      Mo();
  }
  function ti() {
  ...
  function ui(t) {
    (xn.lean && xn.lite) ||
      ...
      t.CSSStyleSheet &&
        ...
        (ci(t, "replace", 1), ci(t, "replaceSync", 2)));
  }
  function ci(t, e, n) {
    void 0 === t.__clr[e] &&
      ((t.__clr[e] = t.CSSStyleSheet.prototype[e]),
      (t.CSSStyleSheet.prototype[e] = function () {
        return (
          yo() && bt.includes(this[gt]) && fi(Cn(), this[gt], n, arguments[0]),
  ...
  function si(t, e) {
    ...
    if (
      (!xn.lean || !xn.lite) &&
      (yt.includes(t) || (yt.push(t), t.defaultView && ui(t.defaultView)),
      (e = e || Cn()),
      null == t ? void 0 : t.adoptedStyleSheets)
    ) {
      for (n = [], a = 0, i = t.adoptedStyleSheets; a < i.length; a++)
        ((r = i[a])[gt] && bt.includes(r[gt])) ||
          ((r[gt] = no()),
          bt.push(r[gt]),
          fi(e, r[gt], 0),
          fi(e, r[gt], 2, Wi(r))),
        ...
        (u.length === c.length &&
          ...
          ((function (t, e, n, a) {
            pt.push({
              time: t,
              event: 45,
              data: { id: e, operation: 3, newIds: a },
            }),
              bi(45);
  ...
  function fi(t, e, n, a) {
    ht.push({ time: t, event: 46, data: { id: e, operation: n, cssRules: a } }),
      bi(46);
  }
  function hi() {
    wt = [];
  ...
  function vi(t, e) {
    ...
    if (
      yo() &&
      null !==
        (a = (null == (n = t.effect) ? void 0 : n.target)
          ? Fi(n.target)
          : null) &&
      n.getKeyframes &&
      n.getTiming &&
        ...
        return ta(this, function (R) {
          switch (R.label) {
            ...
            case 2:
              ...
              return sr(), [3, 13];
            case 3:
              for (l = 0, s = pt; l < s.length; l++)
                (g = s[l]),
                  (i = [g.time, g.event]).push(
                    g.data.id,
                    g.data.operation,
                    g.data.newIds
                  ),
                  wr(i);
              for (d = 0, f = ht; d < f.length; d++)
                (g = f[d]),
                  (i = [g.time, g.event]).push(
                    g.data.id,
                    g.data.operation,
                  ...
                  switch (O) {
                    case "tag":
                      (x = wi(b)),
                        ...
                        b.parent &&
                          S &&
                          (i.push(b.parent), b.previous && i.push(b.previous)),
                        i.push(E ? "*M" : k[O]),
                        x &&
                          2 === x.length &&
                          i.push(
                            "#" + x[0].toString(36) + "." + x[1].toString(36)
                          );
                      break;
                    case "attributes":
                      for (D in k[O])
  ...
  function ki(t, e, n, a) {
    return "href" === t && "LINK" === a
      ? t + "=" + e
      : t + "=" + Pn(e, 0 === t.indexOf("data-") ? "data-" : t, n);
  }
  function Si() {
    Ot = null;
  }
  function Ei() {
    ...
    (null !== Ot && c === Ot.width && g === Ot.height) ||
      null === c ||
      null === g ||
      ((Ot = { width: c, height: g }), bi(8));
  }
  function Ti(t, e, n, a) {
    return $n(this, void 0, void 0, function () {
      var i, r, o, u, c;
      return ta(this, function (l) {
        switch (l.label) {
          ...
          case 1:
            ...
            for (r = i.shift(), o = r.firstChild; o; )
  ...
  function Mi(t) {
    ...
    !(function (t, e) {
      var n, a;
      6 in y
        ? e - (a = (n = y[6])[n.length - 1])[0] > 100
          ? y[6].push([e, 0])
          : (a[1] = e - a[0])
        : (y[6] = [[e, 0]]);
    })(0, e),
      It.push({ time: e, mutations: t }),
              ...
              (o = xn.throttleDom
                ? (function (t, e, n, a) {
                    var i,
                      ...
                      u,
                      c,
                      l = t.target ? $i(t.target.parentNode) : null;
                    return l &&
                      "HTML" !== l.data.tag &&
                      ((i = a > Rt),
                      (o =
                        (r = $i(t.target)) && r.selector
                          ? r.selector.join()
                          : t.target.nodeName),
                      (u = [
                        l.selector ? l.selector.join() : "",
                        o,
                        t.attributeName,
                        xi(t.addedNodes),
                        xi(t.removedNodes),
          ...
          case 8:
            return u < c.length
              ? ((l = c[u]),
                (s = Dt[l]),
                delete Dt[l],
                [4, _i(t, s.mutation, Cn(), s.timestamp)])
              : [3, 11];
          case 9:
            ...
            return (
              (function () {
                var t,
                  ...
                  a = Cn();
                for (
                  Object.keys(Lt).length > 1e4 && ((Lt = {}), Bn(38)),
                    t = 0,
                    e = Object.keys(Lt);
                  t < e.length;
                  t++
                )
                  (n = e[t]), a > Lt[n][1] + 3e4 && delete Lt[n];
              })(),
              Ar(t),
              [2]
            );
  ...
  function Ai(t) {
    if (
      ...
      "Element" in t &&
        t.Element &&
        t.Element.prototype &&
        void 0 === t.__clr.AttachShadow)
    ) {
      t.__clr.AttachShadow = t.Element.prototype.attachShadow;
      try {
        t.Element.prototype.attachShadow = function () {
          return yo()
            ? Di(t.__clr.AttachShadow.apply(this, arguments))
            : t.__clr.AttachShadow.apply(this, arguments);
        };
      } catch (e) {
  ...
  function Pi(t, e, n, a, i) {
    e in t &&
      ...
      t[e].prototype &&
      void 0 === t.__clr[n] &&
      ((t.__clr[n] = t[e].prototype[a]),
      (t[e].prototype[a] = function () {
        return yo() && Di(i.call(this)), t.__clr[n].apply(this, arguments);
      }));
  }
  function Ri(t) {
    var e, n, a, i;
    for (e = 0, n = Object.keys(t); e < n.length; e++) {
      if (((i = t[(a = n[e])]), "@type" === a && "string" == typeof i))
        switch (
          (i =
            (i = i.toLowerCase()).includes("article") || i.includes("posting")
              ? "article"
              : i)
        ) {
          case "article":
  ...
  function Yi(t, e, n) {
    ...
    switch (
      ...
      case Node.DOCUMENT_TYPE_NODE:
        i(
          t,
          (r = o && t.parentNode ? Ji(t.parentNode) : r),
          {
            tag: (o ? "iframe:" : "") + "*D",
            attributes: {
      ...
      case Node.DOCUMENT_FRAGMENT_NODE:
        (c = t).host &&
          ...
          c.constructor.toString().includes("[native code]")
            ? (ji(c),
              (l = { tag: "*S", attributes: { style: "" } }),
              i(t, c.host, l, e))
            : i(t, c.host, { tag: "*P", attributes: {} }, e),
          si(t, n));
        break;
      case Node.TEXT_NODE:
        (r = r || t.parentNode),
          (i === Bi ||
            (r &&
              ...
              "STYLE" !== r.tagName &&
              "NOSCRIPT" !== r.tagName)) &&
            i(t, r, { tag: "*T", value: t.nodeValue }, e);
        break;
      case Node.ELEMENT_NODE:
        switch (
          ...
          (f = (function (t) {
            ...
            if (i && i.length > 0)
              for (e = 0; e < i.length; e++)
                (n = i[e].name), Wt.includes(n) || (a[n] = i[e].value);
            return (
              "INPUT" === t.tagName &&
                !("value" in a) &&
                t.value &&
          ...
          case "SCRIPT":
            ...
            break;
          case "NOSCRIPT":
            i(t, r, { tag: d, attributes: {}, value: "" }, e);
            break;
          case "META":
            if (
              (h =
                "property" in f ? "property" : "name" in f ? "name" : null) &&
              "content" in f
            )
              switch (((p = f.content), f[h])) {
                case "og:title":
                  qr(20, p);
                  break;
                case "og:type":
          ...
          case "BASE":
            (m = $i(t.parentElement)) &&
              (((y = document.createElement("a")).href = f.href),
              (m.data.attributes["*B"] =
                y.protocol + "//" + y.host + y.pathname));
            break;
          case "STYLE":
            i(
              t,
          ...
          case "IFRAME":
            (w = { tag: d, attributes: f }),
              (function (t) {
                ...
                ((function (t) {
                  !1 === tr(t) &&
                    co(t, "load", Ci.bind(this, t, "childList"), !0);
                })(b),
                (w.attributes["*O"] = "true"),
                b.contentDocument &&
                  b.contentWindow &&
                  "loading" !== b.contentDocument.readyState &&
                  (_ = b.contentDocument)),
              2 === e && Xi(b),
              i(t, r, w, e);
            break;
            ...
            if (Ge && "stylesheet" === f.rel) {
              for (k in Object.keys(document.styleSheets))
                if ((S = document.styleSheets[k]).ownerNode == s) {
                  i(t, r, { tag: "STYLE", attributes: f, value: Wi(S) }, e);
                  break;
                }
              break;
            }
            i(t, r, { tag: d, attributes: f }, e);
            break;
          case "VIDEO":
          case "AUDIO":
          case "SOURCE":
  ...
  function ji(t) {
    tr(t) ||
      ...
      ((function (t) {
        ...
        try {
          (n =
            (e = In("MutationObserver")) in window
              ? new window[e](uo(Mi))
              : null) &&
            (n.observe(t, {
              attributes: !0,
      ...
      (function (t) {
        !(function (t) {
          ...
          t.nodeType === Node.DOCUMENT_NODE &&
            ...
            (function (t) {
              co(t, "input", Da, !0), co(t, "keydown", Ca, !0);
            })(t),
            (function (t) {
  ...
  function Xi(t) {
    ...
    c && so(c),
      o &&
        (so(o),
        (e = o),
        (n = Yt.get(e)) && (n.disconnect(), xt.delete(n), Yt.delete(e)),
        (function (t, e) {
  ...
  function Wi(t) {
    ...
    try {
      ...
      if ((_r(1, 1, t ? t.name : null), t && "SecurityError" !== t.name))
        throw t;
    }
    if (null !== a) for (e = 0; e < a.length; e++) n += a[e].cssText;
    return n;
  }
  function Hi(t, e) {
    var n,
      ...
      default:
        return null === u
          ...
          : ((u += ">"),
            ...
            (i =
              "BODY" !== t.tag && "class" in o && o.class.length > 0
                ? o.class
                    .trim()
                    .split(/\s+/)
                    .filter(function (t) {
  ...
  function Vi(t, e, n, a) {
    var i,
      ...
      l,
      s = e ? Fi(e) : null;
    ((e && s) || null != t.host || t.nodeType === Node.DOCUMENT_TYPE_NODE) &&
      ((i = Fi(t, !0)),
      (r = nr(t)),
      (o = null),
      (u = rr(t) ? i : null),
      ...
      (function (t, e, n) {
        ...
        switch (!0) {
          ...
          case 1 === h:
            ...
            break;
          case "IMG" === g:
            (null === (a = p.src) || void 0 === a
              ? void 0
              : a.startsWith("blob:")) && (f.privacy = 3);
        }
      })(t, Vt[i], o),
      Gi(Vt[i]),
      (function (t) {
  ...
  function Bi(t, e, n, a) {
    ...
    if (l in Vt) {
      ...
      i.previous !== d && ((f = !0), (i.previous = d)),
      i.parent !== s &&
        ((f = !0),
        (r = i.parent),
        (i.parent = s),
        null !== s && s >= 0
          ? ((o = null === d ? 0 : Vt[s].children.indexOf(d) + 1),
            Vt[s].children.splice(o, 0, l),
            (i.region = rr(t) ? l : Vt[s].region))
          : (function (t, e) {
              if (t in Vt) {
                var n = Vt[t];
        ...
        null !== r &&
          r >= 0 &&
          (u = Vt[r].children.indexOf(l)) >= 0 &&
          Vt[r].children.splice(u, 1),
        (h = !0)),
      n))
        Ki(i.data, n, c) && ((f = !0), (i.data[c] = n[c]));
      Gi(i), ar(l, a, f, h);
    }
  }
  function Ji(t) {
  ...
  function Ki(t, e, n) {
    ...
    if ("object" == typeof t[n] && "object" == typeof e[n]) {
      for (a in t[n]) if (t[n][a] !== e[n][a]) return !0;
      for (a in e[n]) if (e[n][a] !== t[n][a]) return !0;
      return !1;
    }
    return t[n] !== e[n];
  }
  function Gi(t) {
    var e = t.parent && t.parent in Vt ? Vt[t.parent] : null,
      ...
      i = (function (t, e) {
        var n, a;
        for (
          e.metadata.position = 1, n = t ? t.children.indexOf(e.id) : -1;
          n-- > 0;
  ...
  function Zi(t) {
    var e = (function (t) {
      ...
      n = Qi(e);
    return null !== n && null !== n.textContent
      ? n.textContent.substr(0, 25)
      : "";
  }
  function Qi(t) {
  ...
  function er(t) {
    var e,
      ...
      i = Ft.get(t);
    if (
      (null == i ? void 0 : i.nodeType) !== Node.DOCUMENT_FRAGMENT_NODE &&
      (i &&
  ...
  function nr(t) {
    for (var e = null; null === e && t.previousSibling; )
      (e = Fi(t.previousSibling)), (t = t.previousSibling);
    return e;
  }
  function ar(t, e, n, a) {
    if (
      (void 0 === n && (n = !0), void 0 === a && (a = !1), !xn.lean || !xn.lite)
    ) {
      var i = Bt.indexOf(t);
      i >= 0 && 1 === e && a
        ? (Bt.splice(i, 1), Bt.push(t))
        : -1 === i && n && Bt.push(t);
    }
  }
  function ir(t, e) {
  ...
  function or() {
    var t,
      ...
      a,
      i = [];
    for (t = 0, e = le; t < e.length; t++)
      (a = Fi((n = e[t]).node))
        ? ((n.state.data.id = a), (ce[a] = n.state.data), oe.push(n.state))
        : i.push(n);
      ...
      (i = (a = n[e]).target),
        ...
        ue.has(i) &&
          ...
          ((l =
            (c = i ? Fi(i) : null) in ce
              ? ce[c]
              : { id: c, name: ue.get(i), interaction: 16, visibility: 0 }),
          (d =
            ((s =
              (o ? (o.width * o.height * 1) / (u.width * u.height) : 0) >
                0.05 || a.intersectionRatio > 0.8) ||
              10 == l.visibility) &&
            Math.abs(r.top) + u.height > r.height),
  ...
  function cr(t, e, n, a) {
    ...
    (e.interaction = n > e.interaction ? n : e.interaction),
      ...
      e.id
        ? ((e.id in ce && i) || !(e.id in ce)) &&
          ((ce[e.id] = e), oe.push(lr(e)))
        : le.push({ node: t, state: lr(e) });
  }
  function lr(t) {
    return {
      time: Cn(),
          ...
          (function (t, e) {
            var n = Qi(t),
              a =
                t in ce
                  ? ce[t]
                  : { id: t, visibility: 0, interaction: 16, name: ue.get(n) },
              i = 16;
            switch (e) {
              case 9:
                i = 20;
          ...
          switch (((n = e || Cn()), (a = [n, t]), t)) {
            ...
            case 20:
              for (i = 0, r = F; i < r.length; i++)
                (Y = r[i]),
                  (o = fr(Y.data.target, Y.event)).id > 0 &&
                    ((a = [Y.time, Y.event]).push(o.id),
                    a.push(Y.data.x),
                    a.push(Y.data.y),
                    void 0 !== Y.data.id &&
                      (a.push(Y.data.id),
                      void 0 !== Y.data.isPrimary &&
                        a.push("" + Y.data.isPrimary)),
                    wr(a),
                    (void 0 === Y.data.isPrimary || Y.data.isPrimary) &&
            ...
            case 48:
              for (u = 0, c = H; u < c.length; u++)
                (Y = c[u]),
                  ...
                  a.push(
                    ...
                    Y.data.reaction,
                    Y.data.context,
                    Pn(Y.data.text, "click", d.privacy),
                    Rn(Y.data.link),
                    f,
                    Y.data.trust,
                    Y.data.isFullText,
              ...
              break;
            case 38:
              for (h = 0, p = q; h < p.length; h++)
                (Y = p[h]),
                  (a = [Y.time, Y.event]),
                  (P = fr(Y.data.target, Y.event)).id > 0 &&
                    (a.push(P.id), a.push(Y.data.action), wr(a));
              Ia();
              break;
            case 11:
              (g = G),
            ...
            case 10:
              ...
              break;
            case 42:
              for (I = 0, D = j; I < D.length; I++)
                (Y = D[I]),
                  (a = [Y.time, Y.event]),
                  (P = fr(Y.data.target, Y.event)).id > 0 &&
                    ((a = [Y.time, Y.event]).push(P.id),
                    a.push(Y.data.type),
  ...
  function gr(t, e, n, a, i, r, o) {
    void 0 === r && (r = 1),
      ...
      fe.push({
        time: t,
        event: 22,
        data: { type: e, hash: n, x: a, y: i, reaction: r, context: o },
      }),
      qn(e, a, i, t);
  }
  function vr(t, e, n, a) {
  ...
  function br(t) {
    ...
    ye &&
      (((n =
        (e = t ? t.split(" ") : [""]).length > 1 ? parseInt(e[1], 10) : null) &&
        be.has(n)) ||
        (function (t, e) {
          try {
  ...
  function wr(t, e) {
    ...
    if ((void 0 === e && (e = !0), Me)) {
      switch (
        ...
        (i = JSON.stringify(t)),
        xn.lean
          ? !Oe && ke + i.length > 10485760 && (_r(10, 0), (Oe = !0))
          : (Oe = !1),
        a)
      ) {
        case 5:
      ...
      Bn(25),
        (r = (function () {
          ...
          return "string" == typeof xn.upload
            ? Math.max(Math.min(t, 3e4), 100)
            : xn.delay;
        })()),
        n - _e > 2 * r && (Zn(Te), (Te = null)),
        e &&
          null === Te &&
          (25 !== a && (m && Zn(m), (m = Gn(Qn, v)), (g = Cn())),
          (Te = Gn(kr, r)),
          (_e = n),
          (function (t) {
            if (0 === qe.check) {
              ...
              return Me
                ? ((Te = null),
                  (e =
                    !1 === xn.lean &&
                    ke > 0 &&
                    (ke < 1048576 || tn.sequence > 0)) && Kn(1, 1),
                  or(),
                  (function () {
                    var t, e, n, a, i, r;
                    if (tn) {
                        ...
                        try {
                          for (t in E)
                            if (
                              ...
                              for (a in (n = E[e]))
                                (r = (v = fa(ca(n[(i = parseInt(a))])))
                                  ? JSON.stringify(v).slice(0, 1e4)
                                  : v) && sa(e, i, r);
                              for (u in (o = T[e]))
                                (c = !1),
                                  (s = o[(l = parseInt(u))]).startsWith("@") &&
                                    ((c = !0), (s = s.slice(1))),
                                  (d = document.querySelectorAll(s)) &&
                                    ...
                                    sa(
                                      e,
                                      l,
                                      (c ? An(f).trim() : f).slice(0, 1e4)
                                    ));
                              for (p in (h = N[e]))
                                sa(
                                  e,
                                  (g = parseInt(p)),
                                  Zi(h[g]).trim().slice(0, 1e4)
                                );
                            }
                          S.size > 0 && Wr(40);
                        } catch (t) {
                  ...
                  (function () {
                    var t, e, n, a;
                    for (t = 0, e = yt; t < e.length; t++)
                      si(
                        (n = e[t]),
                        (a = n == document ? -1 : Fi(n)) in mt ? mt[a] : null
                      );
                  })(),
                  (n = !0 === t),
                  tn
                    ? ((a = JSON.stringify(
                        (function (t) {
                          return (
                            (tn.start = tn.start + tn.duration),
                            (tn.duration = Cn() - tn.start),
                            tn.sequence++,
                            (tn.upload =
                              t && "sendBeacon" in navigator ? 1 : 0),
                            (tn.end = t ? 1 : 0),
                      ...
                      (i = Ee),
                      (Ee = []),
                      e && ((r = Se), (Se = []), (ke = 0), (we = 0), (Oe = !1)),
                      (o = "[" + i.join() + "]"),
                      (u = e ? "[" + r.join() + "]" : ""),
                      n &&
                        u.length > 0 &&
                        a.length + o.length + u.length > 65536 &&
                        (u = ""),
                      (c =
                        (h = { e: a, a: o, p: u }).p.length > 0
                          ? '{"e":' + h.e + ',"a":' + h.a + ',"p":' + h.p + "}"
                          : '{"e":' + h.e + ',"a":' + h.a + "}"),
                      n ? ((d = null), [3, 3]) : [3, 1])
                    : [2])
  ...
  function Sr(t, e, n, a) {
    ...
    if ((void 0 === a && (a = !1), "string" == typeof xn.upload)) {
      if (((i = xn.upload), (r = !1), a && navigator && navigator.sendBeacon))
        try {
          (r = navigator.sendBeacon.bind(navigator)(i, t)) && Tr(n);
        } catch (t) {}
      !1 === r &&
        (n in Ne ? Ne[n].attempts++ : (Ne[n] = { data: t, attempts: 1 }),
    ...
    t &&
      ...
      ((t.status < 200 || t.status > 208) && n.attempts <= 1
        ? t.status >= 400 && t.status < 500
          ? Hr(6)
          : (0 === t.status &&
              (xn.upload = xn.fallback ? xn.fallback : xn.upload),
            (xe = { sequence: e, attempts: n.attempts, status: t.status }),
            Wr(2),
            Sr(n.data, null, e))
        : ((xe = { sequence: e, attempts: n.attempts, status: t.status }),
          n.attempts > 1 && Wr(2),
          200 === t.status &&
            ...
            (function (t) {
              var e, n, a, i;
              for (
                e = 0, n = t && t.length > 0 ? t.split("\n") : [];
                e < n.length;
                e++
              )
                switch (
                  (i = (a = n[e]) && a.length > 0 ? a.split(/ (.*)/) : [""])[0]
                ) {
                  case "END":
                    Hr(6);
                    break;
                  ...
                  case "SNAPSHOT":
                    (xn.lean = !1),
                      ...
                      (function (t) {
                        for (
                          var e, n, a, i, r, o, u, c, l = [document];
                          l.length > 0;
                          ...
                          switch (i.nodeType) {
                            ...
                            case Node.ELEMENT_NODE:
                              (e = mr((c = i))),
                                (n = ["NOSCRIPT", "SCRIPT", "STYLE"].includes(
                                  c.tagName
                                )
                                  ? n
                                  : c.tagName);
                          }
                          yr(i, o, { tag: n, attributes: e, value: a });
                        }
                      })(),
                      (function (t) {
                        $n(this, void 0, void 0, function () {
          ...
          0 === t.status && (Sr(n.data, null, e, !0), Hr(3)),
  ...
  function Nr(t) {
    var e = t.error || t;
    return (
      e.message in Ie || (Ie[e.message] = 0),
      Ie[e.message]++ >= 5 ||
        (e &&
          e.message &&
          ((De = {
    ...
    return $n(this, void 0, void 0, function () {
      ...
      return ta(this, function (n) {
        switch (((e = [Cn(), t]), t)) {
          ...
          case 33:
            Ae &&
              (e.push(Ae.code, Ae.name, Ae.message, Ae.stack, Ae.severity),
              wr(e, !1));
            break;
          case 41:
  ...
  function _r(t, e, n, a, i) {
    void 0 === n && (n = null),
      ...
      void 0 === i && (i = null);
    var r = n ? n + "|" + a : "";
    (t in Ce && Ce[t].includes(r)) ||
      ((Ae = { code: t, name: n, message: a, stack: i, severity: e }),
  ...
  function Ir() {
    ...
    t &&
      ...
      t
        ...
        .catch(function (e) {
          t.id === Jr() &&
            (e && _r(0, 1, e.name, e.message, e.stack), (Ye = null), Ir());
        }));
  }
  function Dr(t) {
    var e = Rr(t);
    return e in Re
      ? performance.now() - Re[e].start > Re[e].yield
        ? 0
        : 1
      : 2;
  }
  function Cr(t) {
    Re[Rr(t)] = { start: performance.now(), calls: 0, yield: 30 };
  }
  function Ar(t) {
    ...
    switch (t) {
      ...
      case 34:
        if ((a = Object.keys(w)).length > 0) {
          for (i = 0, r = a; i < r.length; i++)
            (o = r[i]), _.push(o), _.push(w[o]);
          ia(), wr(_, !1);
        }
        break;
      case 0:
        if ((u = Object.keys(h)).length > 0) {
          for (l = 0, s = u; l < s.length; l++)
            (f = s[l]),
              (g = parseInt(f, 10)),
              _.push(g),
      ...
      case 1:
        if ((v = Object.keys(ze)).length > 0) {
          for (m = 0, b = v; m < b.length; m++)
            (n = b[m]), (g = parseInt(n, 10)), _.push(g), _.push(ze[n]);
          (ze = {}), (Fe = !1), wr(_, !1);
        }
        break;
      case 36:
      ...
      case 40:
        S.forEach(function (t) {
          var e, n, a;
          for (n in (_.push(t), (e = []), k[t]))
            (a = parseInt(n, 10)), e.push(a), e.push(k[t][n]);
          _.push(e);
        }),
          la(),
          wr(_, !1);
  ...
  function Br() {
    ...
    if (
      !Qe &&
      "granted" === (null == Ze ? void 0 : Ze.analytics_Storage) &&
      "granted" === (null == Ze ? void 0 : Ze.ad_Storage)
    ) {
      for (t = 0, e = xn.cookies; t < e.length; t++)
        (a = va((n = e[t]))) && na(n, a);
      Qe = !0;
    }
  }
  ...
  function Kr(t, e) {
    var n, a, i;
    if ((void 0 === t && (t = $e), void 0 === e && (e = 5), yo())) {
      if (
        ((a = {
          source: null !== (n = t.source) && void 0 !== n ? n : e,
          ad_Storage: Zr(t.ad_Storage, null == Ze ? void 0 : Ze.ad_Storage),
          analytics_Storage: Zr(
            t.analytics_Storage,
            null == Ze ? void 0 : Ze.analytics_Storage
          ),
        }),
        Ze &&
          a.ad_Storage === Ze.ad_Storage &&
          a.analytics_Storage === Ze.analytics_Storage)
      )
        return (Ze.source = a.source), Vr(Gr(Ze)), void zr();
      if (((Ze = a), $r(!0), !(i = Gr(Ze)).analytics_Storage && xn.track))
        return (xn.track = !1), Qr(!0), Mo(), void window.setTimeout(No, 250);
      yo() && i.analytics_Storage && ((xn.track = !0), eo(io(), 1), to()),
        Br(),
        Vr(i),
        zr();
    }
  ...
  function Zr(t, e) {
    return (
      void 0 === e && (e = "denied"), "string" == typeof t ? t.toLowerCase() : e
    );
  }
  function Qr(t) {
        ...
        if ((void 0 === e && (e = !1), Ke.length > 0))
          for (n = 0; n < Ke.length; n++)
            (a = Ke[n]).callback &&
              ...
              (!a.wait || t) &&
              (a.callback(Je, !xn.lean, a.consentInfo ? Ze : void 0),
              (a.called = !0),
              a.recall || (Ke.splice(n, 1), n--));
      })(xn.lean ? 0 : 1, t);
  }
  function to() {
    var t, e, n;
    Je &&
      ...
      (e =
        xn.upload && "string" == typeof xn.upload
          ? xn.upload.replace("https://", "")
          : ""),
      (n = xn.lean ? 0 : 1),
  ...
  function eo(t, e) {
    ...
    void 0 === e && (e = null),
      ...
      (null === t.expiry ||
        ...
        t.consent !== e ||
        t.dob !== a) &&
        ma("_clck", [Je.userId, 2, n.toString(36), e, a].join(O), 365);
  }
  function no() {
  ...
  function io() {
    var t,
      e = { id: no(), version: 0, expiry: null, consent: 0, dob: 0 },
      n = va("_clck", !xn.includeSubdomains);
    return (
      n &&
        n.length > 0 &&
        ((t = n.includes("^") ? n.split("^") : n.split("|")).length > 1 &&
          (e.version = ao(t[1])),
  ...
  function uo(t) {
    return function () {
      ...
      Jn(4, (e = performance.now() - n)),
        e > 30 && (Bn(7), Kn(6, e), t.dn && _r(9, 0, t.dn + "-" + e));
    };
  }
  function co(t, e, n, a, i) {
    void 0 === a && (a = !1), void 0 === i && (i = !0), (n = uo(n));
    try {
      t[In("addEventListener")](e, n, { capture: a, passive: i }),
        fo(t) || nn.set(t, []),
        nn
          .get(t)
          .push({ event: e, listener: n, options: { capture: a, passive: i } });
    } catch (t) {}
  }
  function lo() {
  ...
  function go() {
    (un = 0), on !== mo() && (Mo(), window.setTimeout(vo, 250));
  }
  function vo() {
    No(), Kn(29, 1);
  }
  ...
  function So() {
    ...
    try {
      for (
        ...
        (n = e[t]),
          PerformanceObserver.supportedEntryTypes.includes(n) &&
            ("layout-shift" === n && Jn(9, 0),
            Sn.observe({ type: n, buffered: !0 }));
    } catch (t) {
      _r(3, 1);
    }
  }
  ...
  (t = 0),
        ...
        start: function () {
          ...
          (Be = !0),
            (null == e ? void 0 : e.addListener) &&
              e.addListener(["ad_storage", "analytics_storage"], Ur);
        },
        stop: function () {
          Be = !0;
        },
      },
      {
        start: function () {
          var t,
            ...
            d,
            f =
              navigator && "userAgent" in navigator ? navigator.userAgent : "",
            h =
              null !==
                (n =
          ...
          (Ge = f.indexOf("Electron") > 0 ? 1 : 0),
            ...
            (s = va("_clsk", !xn.includeSubdomains)) &&
              (c = s.includes("^") ? s.split("^") : s.split("|")).length >= 5 &&
              l.ts - ao(c[1]) < 18e5 &&
              ((l.session = c[0]),
              (l.count = ao(c[2]) + 1),
              (l.upgrade = ao(c[3])),
            ...
            (xn.lean =
              xn.track && null !== a.upgrade ? 0 === a.upgrade : xn.lean),
            (xn.upload =
              xn.track &&
            ...
            qr(
              ...
              (function () {
                ...
                return (
                  xn.track &&
                    pa(window, "sessionStorage") &&
                    ((t = sessionStorage.getItem("_cltk") || t),
            ...
            Kn(1, 0),
            Kn(35, Ge),
            (o = null === window || void 0 === window ? void 0 : window.Zone) &&
              "__symbol__" in o &&
              Kn(39, 1),
            navigator &&
              ...
              (u = navigator.userAgentData) && u.getHighEntropyValues
                ? u
    ...
    (Ze = null),
    (Qe = !1),
    ($e = { source: 7, ad_Storage: "denied", analytics_Storage: "denied" }),
    (tn = null),
    (nn = new Map()),
    (an = null),
    (rn = null),
    ...
    (vn = function (t) {
      "interactionCount" in performance
        ? (sn = performance.interactionCount)
        : t.interactionId &&
          ((dn = Math.min(dn, t.interactionId)),
    ...
    (kn = function (t) {
      ...
      !t.interactionId ||
        ...
        ((n = gn.get(t.interactionId)) ||
          ...
          pn.length > 10 &&
            pn.splice(10).forEach(function (t) {
          ...
          Si(),
            ...
            (function () {
              ...
              if (
                ...
                St ||
                  ((St = !0),
                  ["play", "pause", "commitStyles", "cancel", "finish"].forEach(
                    gi
                  )),
                null === kt &&
                  ((kt = Element.prototype.animate),
                ...
                for (t = 0, e = document.getAnimations(); t < e.length; t++)
                  "finished" === (n = e[t]).playState
                    ? vi(n, "finish")
                    : "paused" === n.playState || "idle" === n.playState
                    ? vi(n, "pause")
                    : "running" === n.playState && vi(n, "play");
            })();
        },
        stop: function () {
          sr(),
            ...
            (function () {
              var t, e, n;
              for (t = 0, e = Array.from(xt); t < e.length; t++)
                (n = e[t]) && n.disconnect();
              (xt = new Set()),
                (Lt = {}),
                (It = []),
              ...
              navigator &&
                ...
                PerformanceObserver.supportedEntryTypes
                  ? "complete" !== document.readyState
                    ? co(window, "load", Gn.bind(this, So, 0))
                    : So()
                  : _r(3, 0);
            })();
        },
        stop: function () {
          Sn && Sn.disconnect(), (Sn = null), wn(), (Tn = null), wo();
        },
      },
      {
        start: function () {
    ...
    (Mn = {
                ...
                case 1:
                  return (
                    ...
                    (r.userHint =
                      a ||
                      ((u = t) && u.length >= 5
                        ? u.substring(0, 2) + jn(u.substring(2), "*", "*")
                        : jn(u, "*", "*"))),
                    aa("userId", [(i = r).userId]),
                    aa("userHint", [i.userHint]),
                    aa("userType", [oa(t)]),
                    e && (aa("sessionId", [e]), (i.sessionId = e)),
                    n && (aa("pageId", [n]), (i.pageId = n)),
                    [2, i]
                  );
              }
              var u;
      ...
      metadata: function (t, e, n, a) {
        ...
        void 0 === e && (e = !0),
          ...
          (i = xn.lean ? 0 : 1),
          (r = !1),
          Je && (i || !1 === e) && (t(Je, !xn.lean, a ? Ze : void 0), (r = !0)),
          (!n && r) ||
            Ke.push({
              callback: t,
              wait: e,
