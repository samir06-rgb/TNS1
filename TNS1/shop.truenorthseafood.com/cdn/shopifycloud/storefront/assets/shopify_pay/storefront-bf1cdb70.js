(() => {
    ...
    "node_modules/.pnpm/core-js@2.6.12/node_modules/core-js/modules/_wks.js"(
      ...
      var $exports = (module.exports = function (name) {
        return (
          store[name] ||
          (store[name] =
            (USE_SYMBOL && Symbol2[name]) ||
            (USE_SYMBOL ? Symbol2 : uid)("Symbol." + name))
        );
      });
      $exports.store = store;
    },
    ...
    "node_modules/.pnpm/core-js@2.6.12/node_modules/core-js/modules/_ie8-dom-define.js"(
      ...
      module.exports =
        ...
        !require_fails()(function () {
          return (
            Object.defineProperty(require_dom_create()("div"), "a", {
              get: function () {
                return 7;
              },
            }).a != 7
  ...
  var require_hide = __commonJS({
    "node_modules/.pnpm/core-js@2.6.12/node_modules/core-js/modules/_hide.js"(
      ...
      module.exports = require_descriptors()
    ...
    "node_modules/.pnpm/core-js@2.6.12/node_modules/core-js/modules/_export.js"(
      ...
      var $export = function (type, name, source) {
        ...
        var target = IS_GLOBAL
          ? global2
          : IS_STATIC
          ? global2[name] || (global2[name] = {})
          : (global2[name] || {})[PROTOTYPE];
  ...
  var require_es6_array_iterator = __commonJS({
    "node_modules/.pnpm/core-js@2.6.12/node_modules/core-js/modules/es6.array.iterator.js"(
      ...
      var Iterators = require_iterators();
      var toIObject = require_to_iobject();
      module.exports = require_iter_define()(
        Array,
        "Array",
  ...
  var require_web_dom_iterable = __commonJS({
    "node_modules/.pnpm/core-js@2.6.12/node_modules/core-js/modules/web.dom.iterable.js"() {
      ...
      for (
        collections = getKeys(DOMIterables), i = 0;
    ...
    "node_modules/.pnpm/core-js@2.6.12/node_modules/core-js/modules/_an-instance.js"(
      ...
      module.exports = function (it, Constructor, name, forbiddenField) {
        if (
          ...
          (forbiddenField !== void 0 && forbiddenField in it)
        ) {
  ...
  var require_species_constructor = __commonJS({
    "node_modules/.pnpm/core-js@2.6.12/node_modules/core-js/modules/_species-constructor.js"(
      ...
      module.exports = function (O, D) {
        ...
        var S;
        return C === void 0 || (S = anObject(C)[SPECIES]) == void 0
          ? D
          : aFunction(S);
      };
    },
    ...
    "node_modules/.pnpm/core-js@2.6.12/node_modules/core-js/modules/_microtask.js"(
      ...
      module.exports = function () {
        ...
        if (isNode) {
          ...
          Observer &&
          !(global2.navigator && global2.navigator.standalone)
        ) {
          var toggle = true;
      ...
      $export(
        $export.S +
          $export.F *
            !(
              USE_NATIVE &&
              require_iter_detect()(function (iter) {
  ...
  var require_promise = __commonJS({
    "node_modules/.pnpm/core-js@2.6.12/node_modules/core-js/es6/promise.js"(
      exports,
      module
    ) {
  ...
  var require_ua_parser = __commonJS({
    "node_modules/.pnpm/ua-parser-js@0.7.40/node_modules/ua-parser-js/src/ua-parser.js"(
      exports,
      module
    ) {
      (function (window2, undefined2) {
        ...
        var UAParser2 = function (ua, extensions) {
          ...
          var _navigator =
            typeof window2 !== UNDEF_TYPE && window2.navigator
              ? window2.navigator
              : undefined2;
          var _ua =
            ua ||
          ...
          this.setUA = function (ua2) {
            _ua =
              typeof ua2 === STR_TYPE && ua2.length > UA_MAX_LENGTH
                ? trim(ua2, UA_MAX_LENGTH)
                : ua2;
            return this;
          };
          this.setUA(_ua);
        ...
        var $ =
          typeof window2 !== UNDEF_TYPE && (window2.jQuery || window2.Zepto);
        if ($ && !$.ua) {
  ...
  var Browser = (function () {
    _createClass(Browser2, [
      ...
      },
      {
        ...
        get: function get() {
          return (
            this.ua.getUA().includes("Android") && this.name.includes("Chrome")
          );
        },
      },
      {
  ...
  function getRedirectState() {
    return window.ShopifyPay.redirectState;
  }
  function getShopifyYCookie() {
    const value = new RegExp(`${SHOPIFY_Y_COOKIE_KEY}=([^;]+)`).exec(
      document.cookie
    );
    if (value) {
      return value[1];
  ...
  function getShopId() {
    if (
      ...
      window.ShopifyAnalytics.lib.config &&
      window.ShopifyAnalytics.lib.config.Trekkie &&
      window.ShopifyAnalytics.lib.config.Trekkie.defaultAttributes &&
      window.ShopifyAnalytics.lib.config.Trekkie.defaultAttributes.shopId
    ) {
      return ShopifyAnalytics.lib.config.Trekkie.defaultAttributes.shopId;
    }
    return null;
  }
  async function setRedirectState(value) {
    await fetch("/shopify_pay/accelerated_checkout", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
      body: JSON.stringify({ shop_pay_redirect: value }),
      credentials: "include",
    });
  }
