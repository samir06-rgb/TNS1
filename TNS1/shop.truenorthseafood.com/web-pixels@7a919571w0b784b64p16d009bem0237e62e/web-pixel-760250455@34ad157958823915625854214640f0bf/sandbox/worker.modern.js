(() => {
  var e = {
      ...
      78: (e, t, r) => {
        ...
        e.exports = function (e, t, r) {
          for (
            var o, i, a = r ? e : e.iterator, s = e.next;
            !(o = n(s, a)).done;
            ...
            Z = function (e, t) {
              ...
              return (
                ...
                (this.setUA = function (e) {
                  return (
                    (n = typeof e === u && e.length > 500 ? H(e, 500) : e), this
                  );
                }),
                this.setUA(n),
                this
            ...
            n(
              ...
              function (e) {
                ...
                f(this, function (e, t) {
                  ...
                  a(t, 1);
                for (
                  var o, s = i(e), c = i(r), d = 0, b = 0, h = !1, m = n.length;
                  d < m;

                )
                  (o = n[d++]),
                    h || o.key === s ? ((h = !0), l(this, o.key)) : b++;
                for (; b < m; )
                  ((o = n[b++]).key === s && o.value === c) ||
        ...
        var n = r(6947),
          ...
          y = (e.exports = function (e, t, r) {
            "Symbol(" === h(d(t), 0, 7) &&
              ...
              (!a(e, "name") || (c && e.name !== t)) &&
                (s
                  ? b(e, "name", { value: t, configurable: !0 })
                  : (e.name = t)),
              w &&
                r &&
                a(r, "arity") &&
            ...
            try {
              r && a(r, "constructor") && r.constructor
                ? s && b(e, "prototype", { writable: !1 })
                : e.prototype && (e.prototype = void 0);
            } catch (o) {}
            var n = f(e);
            return (
              a(n, "source") ||
                (n.source = v(g, "string" == typeof t ? t : "")),
              e
            );
          });
        ...
        (s[d] = !0),
          (e.exports =
            ...
            function (e, t) {
              ...
              return (
                null !== e
                  ? ((b[f] = o(e)), (r = new b()), (b[f] = null), (r[d] = e))
                  : (r = v()),
                void 0 === t ? r : i.f(r, t)
              );
            });
        ...
        var n = r(9731),
          ...
          A = function (e, t) {
            ...
            if (u(n) || (void 0 !== e && !l(e)))
              return (
                (r[1] = function (e, t) {
                  if ((u(n) && (t = a(n, this, b(e), t)), !l(t))) return t;
                }),
                i(h, null, r)
              );
          },
          R = function (e, t, r) {
            var n = v(r, t - 1),
              o = v(r, t + 1);
            return (m(S, e) && !m(k, o)) || (m(k, e) && !m(S, n))
              ? "\\u" + y(w(e, 0), 16)
              : e;
          };
        h &&
          n(
            { target: "JSON", stat: !0, arity: 3, forced: O || E },
            {
              stringify: function (e, t, r) {
                var n = f(arguments),
                  o = i(O ? A : h, null, n);
                return E && "string" == typeof o ? g(o, x, R) : o;
              },
            }
          );
      },
      ...
      8643: (e, t, r) => {
        ...
        p(b, g) || O(g, w),
          (!S && p(b, v) && b[v] !== Object) || O(v, k),
          (k.prototype = b),
          n({ global: !0, constructor: !0, forced: S }, { Iterator: k });
      },
      8963: (e, t, r) => {
        "use strict";
        var n,
      ...
      9544: (e, t, r) => {
        ...
        e.exports = function (e) {
          return (
            i(l, e) || (l[e] = s && i(u, e) ? u[e] : f("Symbol." + e)), l[e]
          );
        };
      },
      9580: (e, t, r) => {
  ...
  (r.amdO = {}),
    ...
    (() => {
          ...
          if ("object" == typeof o) {
            ...
            if (l in o) {
              ...
              Object.defineProperties(b, {
                [t]: { value: f, writable: !1 },
                [e]: { value: p, writable: !1 },
                [n]: { value: d, writable: !1 },
              });
      ...
      const h = "production",
        m = "7a919571w0b784b64p16d009bem0237e62e",
        v = "s7a919571w0b784b64p16d009bem0237e62em.js";
      ...
      const k = (e) => ("number" == typeof e ? new S(e) : new Map()),
        O = (...e) => JSON.stringify(e);
      function E(e, { cache: t, cacheKey: r } = {}) {
        function n(...t) {
          const o = n.cache,
            i = (r ?? O).apply(this, t);
      ...
      const P = (e, t) => {
              ...
              const t = T()
                ...
                .reduce((e, t) => {
                  const r = (function ({
                    ...
                    var o;
                    return {
                      file: `https://cdn.shopify.com/cdn/wpm/${v}`,
                      method: n,
                      lineNumber: t,
                      columnNumber: r,
                    };
        ...
        D = ["number", "boolean", "symbol"],
        _ = (e, { context: t }) => {
          const r = "v1/" + (t ? `${t}/` : "");
          return null == e || D.includes(typeof e) || Array.isArray(e)
            ? `${r}UnknownError`
            : "string" == typeof e
            ? `${r}${e}`
          ...
          notify: (e, t) => {
            try {
              ...
              if (
                ...
                !(function (e) {
                  if (e <= 0 || e > 100)
                    throw new g("Invalid sampling percent", {
              ...
              if (
                n.browserTarget === x.NotAvailable ||
                n.browserTarget === x.Unknown ||
                n.surface === y.NotAvailable ||
                n.surface === y.Unknown ||
                !L(n.shopUrl)
              )
              ...
              const o = (function (e, t) {
                const {
                  ...
                  } = t,
                  {
                    ...
                    try {
                      return new j.UAParser(t).getResult();
                    } catch (e) {
                      return {
                        ua: "",
                  ...
                  events: [
                    {
                      ...
                      request: { url: y, referrer: self.document?.referrer },
                      metaData: {
                        app: {
                          surface: v,
                          library: a,
                          build_target: "modern",
                          env: h,
                          hash_version_sandbox: s || "N/A",
                          sandbox_url: c || "N/A",
                        },
                        device: {
                          user_agent: r || self.navigator?.userAgent,
                          rendering_engine_name: O.name,
                          rendering_engine_version: O.version,
      ...
      async function U(e, t = "") {
        const r = new self.Blob([t], { type: "text/plain" });
        try {
          return (
            await self.fetch(e, { method: "POST", keepalive: !0, body: r }), !0
          );
        } catch {
          return !1;
        }
      }
      function B(e, t, r, n = !0) {
        try {
          const o = {
      ...
      function W(e) {
        (function ({ webPixelApi: e, cookie: t, cookieRestrictedDomains: r }) {
          ...
          B(document, "cookie", {
            ...
            set: function (t) {
              const o = t
                  .split(";")
                  .map((e) => e.trim())
                  .find((e) => e.startsWith("domain=")),
                i = o?.split("=")[1] || "";
              if (r.find((e) => new RegExp(`^\\.?${e}$`).test(i))) return;
              const a = n.getValue();
              n.update(
                () => e.browser.cookie.set(t),
                () =>
                  (function (e, t) {
                    const [r = ""] = t.split(";"),
                      [n, o = ""] = F(r);
          ...
          (function ({ origin: e }) {
            B(window, "origin", { get: () => e, configurable: !1 });
          })(e),
          (function ({ referrer: e }) {
            B(document, "referrer", { get: () => e, configurable: !1 });
          })(e),
          (function ({ webPixelApi: e, localStorageItems: t }) {
            const r = $(t, e.browser.localStorage);
          ...
          (function ({ webPixelApi: e, sessionStorageItems: t }) {
            const r = $(t, e.browser.sessionStorage);
      ...
      const q = new URL(self.location.href);
      class G extends Error {
        constructor(...e) {
      ...
      function H(e) {
        const t = new URL(e);
        if ("https:" !== t.protocol)
          throw new G(`URL must be secure (HTTPS): ${t.href}`);
        if (/^\/api\/.+\/graphql\.json$/.test(t.pathname)) return t;
        const r = q.host.replace(/[/\-\\^$*+?.()|[\]{}]/g, "\\$&");
        if (new RegExp(`^${q.protocol}//(.*@)?${r}`, "i").test(t.href))
          throw new V(`Requests are not allowed to the same origin: ${t.href}`);
        return t;
      }
      const X = Function.prototype.call.bind(XMLHttpRequest.prototype.open);
      r(2341), r(7872);
      const Y = [
        "constructor",
        "hasOwnProperty",
      ...
      function K(e, t) {
        ...
        return r ? K(r, t) : void 0;
      }
      function J(e, t, r) {
        try {
          const n = K(e, t);
          if (!n)
            throw new g(`No explicit target found for ${t}.`, {
              groupingHash: "SandboxEnvironment:Clobber:NoExplicitTarget",
            });
          let o = (function (e, t) {
            try {
              return e[t];
      ...
      Object.defineProperty(self, "webPixelsManager", {
        value: {
          createShopifyExtend: () => ({
            extend: async (e, t) => {
              if ("WebPixel::Render" !== e) throw new te();
              ie = t;
            },
          }),
        },
      ...
      const se = async (e) => {
        ...
        if (ae) {
          ...
          throw (
            (M.notify(e, {
              ...
              shopId: n,
              type: "metric",
              context: "createSandbox/alreadyInitialized",
              userAgent: i.navigator.userAgent || self.navigator.userAgent,
              hashVersionSandbox: m,
              sandboxUrl: q.href || "unknown",
            }),
            e)
          );
        }
        (ae = !0), a(o);
        try {
          ne && (o.browser.sendBeacon = U),
            ne || (W(e), (self.document.title = t));
        } catch (s) {
          throw (
            (M.notify(s, {
              pixelId: r.id,
              ...
              runtimeContext: r.runtimeContext,
              shopId: n,
              context: "createSandbox/restrictEnvironment",
              userAgent: i.navigator.userAgent || self.navigator.userAgent,
              hashVersionSandbox: m,
              sandboxUrl: q.href || "unknown",
            }),
        ...
        return (
          await ie?.call(o, o),
          { status: "success", hashVersion: m, sandboxUrl: q.href || "unknown" }
        );
      };
      (() => {
        try {
          (function (
            e,
            { uuid: t = d, createEncoder: r = f, callable: n } = {}
          ) {
            let i = !1,
              a = e;
            const s = new Map(),
            ...
            return (
              a.addEventListener("message", h),
              {
                ...
                terminate() {
                  b(2, void 0), w(), a.terminate && a.terminate();
                },
              }
            );
            function b(e, t, r) {
                ...
                switch (t[0]) {
                  ...
                  case 0: {
                    ...
                    try {
                      ...
                      const [t, n] = l.encode(await c(...l.decode(a, [e])));
                      b(1, [r, void 0, t], n);
                    } catch (n) {
                      const { name: e, message: t, stack: o } = n;
                      throw (b(1, [r, { name: e, message: t, stack: o }]), n);
                    } finally {
                      e.release();
                    }
                    break;
                  ...
                  case 1: {
                    const [e, r, n] = t[1],
                      o = c.get(e);
                    if (null == o)
                      throw new p({ callId: e, error: r, result: n });
                    o(...t[1]), c.delete(e);
                    break;
                  }
                  case 3: {
                  ...
                  case 5: {
                    const [e, r, o] = t[1];
                    try {
                      const t = await l.call(r, o),
                        [n, i] = l.encode(t);
                      b(6, [e, void 0, n], i);
                    } catch (n) {
                      const { name: t, message: r, stack: o } = n;
                      throw (b(6, [e, { name: t, message: r, stack: o }]), n);
                    }
                    break;
                  }
                }
              ...
              : (function ({ targetOrigin: e = "*" } = {}) {
                  ...
                  return {
                    ...
                    removeEventListener(e, t) {
                      const r = n.get(t);
                      null != r &&
                        (n.delete(t), self.removeEventListener(e, r));
                    },
                  };
                })(),
            { callable: [] }
          ).expose({ initialize: se });
        } catch (e) {
          M.notify(e, { context: `createSandbox/${oe}` });
        }
        !(function (e, t = self) {
          const r = {
            ...(e ? ee : Q),
            fetch:
              ...
              (e, t) => {
                ...
                return H(r.url), n(r, t);
              }),
            XMLHttpRequest:
              ((XMLHttpRequest.prototype.open = function (e, t, r = !0, n, o) {
                return X(this, e, H(t), r, n, o);
              }),
              XMLHttpRequest),
          };
          var n;
          e ||
            (r.addEventListener = (function (e) {
              let t = !1;
              return (r, n, o) => (
                t ||
                  (console.warn(
            ...
            B(self, "String", { writable: !1, configurable: !1 }),
            B(self, "Request", { writable: !1, configurable: !1 }),
            B(self, "URL", { writable: !1, configurable: !1 }),
            B(self, "RegExp", { writable: !1, configurable: !1 });
        })(ne);
      })();
    })();
})();
globalThis.shopify = self.webPixelsManager.createShopifyExtend(
  "760250455",
  "APP"
);
importScripts(
  "/web-pixels/strict/app/web-pixel-760250455@34ad157958823915625854214640f0bf.js"
);
